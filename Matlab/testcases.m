function t = testcases()
 ...
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  temp = washburn(p,T,w);
  if temp ~= answer
	error('Case 0 failed: 1 area, 1 resource');
	failure = 1;
  end
  ...
  temp = washburn(p,T,w);
  if temp ~= answer
	error('Case 1 failed: 4 areas, 1 resource');
	temp
	failure = 1;
  end
  ...
  w      = [4 1 1 12]';
  T      = 0.10;
  answer = [0.092980 0 0 0.007020]';  
  temp = washburn(p,T,w);
  if temp ~= answer
	error('Case 2 failed: 4 areas, 1 resource');
	temp
	failure = 1;
  end
  ...
  if (round(temp*10000) ~= round(answer*10000))
	temp
	answer
	error('Case 3 failed: 3 areas, 1 resource');
	failure = 1;
  end
  ...
  if (round(temp*10000) ~= round(answer*10000))
	temp
	answer
	error('Case 4 failed: 4 areas, 1 resource');
	temp
	failure = 1;
  end
  ...
  if (round(temp*10000) ~= round(answer*10000))
	temp
	answer
	error('Case 5 failed: 3 areas, 1 resource');
	failure = 1;
  end
  ...
  if (round(temp*10000) ~= round(answer*10000))
	temp
	answer
	error('Case 6 failed: No viable searches case');
	failure = 1;
  end
 ...
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  if (round(temp*10000) ~= round(answer*10000))
	temp
	answer
	error('Case 7 failed: 2x2 hand-solvable');
	failure = 1;
  end
  ...
  if (round(temp*10000) ~= round(answer*10000))
	temp
	answer
	error('Case 8 failed:  JOTA example');
	failure = 1;
  end
  ...
  temp = washburn(p,T,w);
  if temp ~= answer
	error('Case 9 failed: Exactly tolerance');
	failure = 1;
  end
